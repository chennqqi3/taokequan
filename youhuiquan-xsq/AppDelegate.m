...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    TKMainViewController *mainVC = [[TKMainViewController alloc] initWithNibName:@"TKMainViewController" bundle:nil];
    ...
    [JPUSHService setupWithOption:launchOptions appKey:@"33356ea519f30256d058c0a2"
                          channel:@"appstore"
